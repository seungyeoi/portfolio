 window.onload = function() {
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.56757342099504, 126.98872610643443),
        level: 2
    };
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.56846170101687, 126.97831504218696),
       level: 2
   };
   ...
   var options4 = {
       center: new daum.maps.LatLng(37.6382568253122, 127.12182739608198),
       level: 2
   };
