   ...
   var on_off=false;  //false(안오버)  true(오버)
       ...
       $('#headerArea').mouseenter(function(){
          // var scroll = $(window).scrollTop();
           ...
           $('#headerArea .logo a').css('background','url(https://seungyeon88.mycafe24.com/common/images/logo2.png) no-repeat');
      ...
      $('#headerArea').mouseleave(function(){
           ...
           $('#headerArea .logo a').css('background','url(https://seungyeon88.mycafe24.com/common/images/logo.png) no-repeat');
           }else{
               $(this).css('background','#fff'); 
               $('.dropdownmenu li a').css('color','#333');
               $('#headerArea .top_menu a').css('color','#666');
